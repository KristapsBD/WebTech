    ...
    <div class="container" align="center">
        ...
        <form action="{{ url('updateproduct', $data->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="p-3">
                ...
                <input class="text-secondary" type="text" name="description" value="{{ $data->description }}"
                    required></input>
            </div>
            <div class="p-3">
                <label>Quantity</label><br>
                <input class="text-secondary" type="number" name="quantity" value="{{ $data->quantity }}"
                    required></input>
            </div>
            <div class="p-3">
            ...
            <button type="submit" class="btn btn-primary btn-lg mb-5">Update product</button>
        </form>
    </div>
</div>
